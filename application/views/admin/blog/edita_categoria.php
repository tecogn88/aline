...
<div class="span12">
	<form method="POST" action="<?php echo base_url('panel/blog/actualizar_categoria/'.$id_categoria); ?>" enctype="multipart/form-data" name="frmArticuloNuevo" id="frmAddArticulo" class="form-horizontal">	
	<div class="well">
		<div class="span8">
			<h2><?=$titulo_pagina?> <small> <?=$descripcion_pagina?></small></h2>
		</div>
		<div class="pull-right">
			<a href="<?php echo base_url('panel/blog/panel_categorias'); ?>" style="margin-left:10px;float:right;" class="btn btn-danger">Cancelar<span style='float:right;margin-left:10px;'><i class='icon-ban-circle icon-white'></i></span></a>
