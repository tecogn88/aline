	...
	<aside id="menu_usuarios" class="span2">
		<div class="tabbable tabs-left">
			<ul class="nav nav-tabs">
				...
				<li class="active"><a href="<?php echo base_url('panel/blog/crea_categoria'); ?>" >Crear categoria<span class='label label-default' style='float:right'><i class='icon-plus icon-white'></i></span></a></li>
			</ul>
		</div>
	</aside>	
...
<div class="span12">
	<form method="POST" action="<?php echo base_url('panel/blog/guarda_categoria') ?>" name="frmArticuloNuevo" id="frmAddArticulo" class="form-horizontal" enctype="multipart/form-data">
	<div class="well">
		<div class="span8">
			<h2><?=$titulo_pagina?> <small> <?=$descripcion_pagina?></small></h2>
		</div>
		<div class="pull-right">
			<a href="<?php echo base_url('panel/blog/panel_categorias/'); ?>" class="btn btn-danger" style="float:right;margin-left:10px;">Cancelar<span style='float:right;margin-left:10px;'><i class='icon-ban-circle icon-white'></i></span></a>
