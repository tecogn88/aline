	...
	<aside id="menu_usuarios" class="span2">
		<div class="tabbable tabs-left">
			<ul class="nav nav-tabs">
				<li class=""><a href="<?php echo base_url('panel/post/'); ?>" >Panel<span class='label label-default' style='float:right'><i class='icon-list icon-white'></i></a></li>
				<li class="active"><a href="<?php echo base_url('panel/post/crea_articulo'); ?>" >Agregar articulo<span class='label label-default' style='float:right'><i class='icon-plus icon-white'></i></span></a></li>
				<li class=""><a href="<?php echo base_url('panel/post/panel_categorias'); ?>" >Panel de categoria<span class='label label-default' style='float:right'><i class='icon-list icon-white'></i></a></li>
...
<form method="POST" action="<?php echo base_url('panel/post/guarda_articulo') ?>" name="frmArticuloNuevo" id="frmAddArticulo" class="form-horizontal" enctype="multipart/form-data">
<div class="row-fluid">
	<div class="well">
		<a style="margin-left:10px;float:right;" class="btn btn-danger" href="<?php echo base_url('panel/post/'); ?>">Cancelar<span style='float:right;margin-left:10px;'><i class='icon-ban-circle icon-white'></i></span></a>
...
<div class="row-fluid">
	...
	<div class="span3">
		...
		<div class="well">
			<label for="porta">
				<strong>
					<h4>Portafolio <input id="porta" value="1" type="checkbox" name="porta" /></h4>
				</strong>
			</label>
		</div>
		<div class="well">
