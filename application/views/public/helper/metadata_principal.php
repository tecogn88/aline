...
<!-- estilos slider bx -->
<link href="<?php echo base_url('assets/css/carousel/jquery.bxslider.css'); ?>" rel="stylesheet" />
<!-- estilos animate -->
...
<link rel="stylesheet" href="<?php echo base_url('assets/media-elements/mediaelementplayer.min.css'); ?>" type="text/css" media="screen" />
<!-- Jquery necesary -->
